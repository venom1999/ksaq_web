/*********************************************************************************
敲矾弊牢 : jquery.DB_gallery.js
力累磊 : Copyright ㄏ 2012 by 叼磊牢喉发(http://designblack.com) 
扼捞季胶 : 档皋牢扼捞季胶
扁鸥 : 夯 敲矾弊牢 颇老狼 沥焊(林籍)绰 昏力且 荐 绝嚼聪促.
       权其捞瘤甫 烹秦 捞侩档皋牢阑 铰牢 罐酒具 钦聪促.
*********************************************************************************/
;(function($){
$.fn.DB_gallery=function(options){
	...
	return this.each(function(){
        ...
        function SetSize()
        {
            $("#DB_gallery .DB_imgSet ").width(750);
            $("#DB_gallery .DB_imgSet ").height(500);
        }
		...
		function changeImg(){
			...
			var $img=$imgWin.find('img');
            $img.css("width",750);
            $img.css("height",500);
			$img.hide().attr('src',_src).fadeIn(opt.fadeSpeed);
            
            oldImg=_src
            //我添加的
            //$("input[id$='currentPic']").val(_src);
            //$("#currentPic").attr("value",_src);
            //
