...
function TreeNode(text, url, iconOpen, iconOpenHover, iconClosed, iconClosedHover) {
	...
	this.CATEGORYOPEN = this.PATH + (iconOpen ? iconOpen : "tree01.gif");
	this.CATEGORYOPEN_HOVER = this.CATEGORYOPEN;
	this.CATEGORYCLOSED = this.PATH + (iconClosed ? iconClosed : "tree02.gif");
	...
	if (url) {
	    this.label.href = url;
	    this.label.target = "Htableframeadd";
	}
