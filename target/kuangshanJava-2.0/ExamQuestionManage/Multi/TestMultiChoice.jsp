...
<head>
    ...
    <script type="text/javascript" src='js/TestMultiChoice.js?<%=Math.random()%>'></script>
    ...
    <style type="text/css">
        ...
        /*多选按钮样式*/
        .add-dialog .el-checkbox__inner {
            margin-left: -100px;
            margin-top: 9px;
        }
        .add-dialog .el-checkbox__label {
            display: none;
        }

        .preview-dialog .el-checkbox__inner {
            margin-left: -100px;
            margin-top: 9px;
        }
        .preview-dialog .el-checkbox__label {
            display: none;
        }

        .detail-dialog .el-checkbox__inner {
            margin-left: -100px;
            margin-top: 9px;
        }
        .detail-dialog .el-checkbox__label {
            display: none;
        }

        .edit-dialog .el-checkbox__inner {
            margin-left: -100px;
            margin-top: 9px;
        }
        .edit-dialog .el-checkbox__label {
            display: none;
        }
    ...
    <el-container>
        <el-header height="48px">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>多选题管理</el-breadcrumb-item>
            </el-breadcrumb>
        </el-header>
            ...
            <div class="content" v-loading="tableLoading" v-cloak>
                ...
                <div class="section">
                    <div class="list-table">
                        <table>
                            ...
                            <tr v-for="(record,index) in unDeletedList" :id="record.multi_choice_id" align="center">
                                <td>
                                ...
                                <td>
                                    <el-button type="text" @click="_detail(record.multi_choice_id)">详细</el-button>
                                    <el-button class="operation-editable" type="text" @click="_edit(record.multi_choice_id);closeFrom('editFrom')">修改</el-button>
                                </td>
                            </tr>
                ...
                <div class="pop-dialog">
                    ...
                    <div class="add-dialog">
                        <el-dialog title="添加多选题" :visible.sync="addDialogVisible" :modal="false" width="26em"
                            ...
                            <el-form label-position="right"  :model="addFrom"
                                ...
                                <el-row>
                                    ...
                                    <el-col :span="24">
                                        <el-form-item label="多选题题干：" prop="multi_choice_content" size="small">
                                            <!-- 加载编辑器的容器 -->
                                            <script id='chooseContent' v-model='addFrom.multi_choice_content' type='text/plain'>
                                            </script>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                                ...
                                <el-row>
                                    <el-col :span="6">
                                        <el-form-item label="选择项A：" prop="multi_choice_a" size="small">
                                            <el-checkbox  v-model="addFrom.answer[0]" label="A"></el-checkbox >
                                            <!-- 加载编辑器的容器 -->
                                            <script id='singleChooseA' class='choose' v-model='addFrom.multi_choice_a' type='text/plain'>
                                            </script>
                                        </el-form-item>
                                    </el-col>

                                    <el-col :span="6" :offset="6">
                                        <el-form-item label="选择项B：" prop="multi_choice_b" size="small">
                                            <el-checkbox  v-model="addFrom.answer[1]" label="B"></el-checkbox >
                                            <!-- 加载编辑器的容器 -->
                                            <script id='singleChooseB' class='choose' v-model='addFrom.multi_choice_b' type='text/plain'>
                                            </script>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                                ...
                                <el-row>
                                    ...
                                    <el-col :span="6">
                                        <el-form-item label="选择项C：" prop="multi_choice_c" size="small">
                                            <el-checkbox v-model="addFrom.answer[2]" label="C"></el-checkbox>
                                            <!-- 加载编辑器的容器 -->
                                            <script id='singleChooseC' class='choose' v-model='addFrom.multi_choice_c' type='text/plain'>
                                            </script>
                                        </el-form-item>
                                    </el-col>

                                    <el-col :span="6" :offset="6">
                                        <el-form-item label="选择项D：" prop="multi_choice_d" size="small">
                                            <el-checkbox v-model="addFrom.answer[3]" label="D"></el-checkbox>
                                            <!-- 加载编辑器的容器 -->
                                            <script id='singleChooseD' class='choose' v-model='addFrom.multi_choice_d' type='text/plain'>
                                            </script>
                                        </el-form-item>
                                    </el-col>
                    ...
                    <div class="preview-dialog">
                        <el-dialog title="预览多选题详细信息" top="2.5vh" :visible.sync="previewDialogVisible" :modal="false"
                                   :close-on-click-modal="false" :close-on-press-escape="false" :show-close="false"
                            ...
                            <el-form label-position="right" :model="previewFrom" ref="previewFrom"
                                ...
                                <el-row>
                                    ...
                                    <el-col :span="12" :offset="6">
                                        ...
                                        <el-form-item label="多选题题干：" prop="multi_choice_content" size="small">
                                            <div class="previewChooseT" v-html="addFrom.multi_choice_content"></div>
                                        </el-form-item>

                                        <el-form-item label="选择项A：" prop="multi_choice_a" size="small">
                                            <el-checkbox v-model="addFrom.answer[0]" label="A" disabled="true"></el-checkbox>
                                            <div class="previewChoose" v-html="addFrom.multi_choice_a"></div>
                                        </el-form-item>

                                        <el-form-item label="选择项B：" prop="multi_choice_b" size="small">
                                            <el-checkbox v-model="addFrom.answer[1]" label="B" disabled="true"></el-checkbox>
                                            <div class="previewChoose" v-html="addFrom.multi_choice_b"></div>
                                        </el-form-item>

                                        <el-form-item label="选择项C：" prop="multi_choice_c" size="small">
                                            <el-checkbox v-model="addFrom.answer[2]" label="C" disabled="true"></el-checkbox>
                                            <div class="previewChoose" v-html="addFrom.multi_choice_c"></div>
                                        </el-form-item>

                                        <el-form-item label="选择项D：" prop="multi_choice_d" size="small">
                                            <el-checkbox v-model="addFrom.answer[3]" label="D" disabled="true"></el-checkbox>
                                            <div class="previewChoose" v-html="addFrom.multi_choice_d"></div>
                                        </el-form-item>
                    ...
                    <div class="detail-dialog">
                        <el-dialog title="查看多选题详细信息" top="2.5vh" :visible.sync="detailDialogVisible" :modal="false"
                                   :close-on-click-modal="false" :close-on-press-escape="false" :show-close="false"
                                   width="26em" fullscreen="true">
                            <el-form label-position="right" :model="detailFrom" ref="detailFrom"
                                ...
                                <el-row>
                                    ...
                                    <el-col :span="12" :offset="6">
                                        ...
                                        <el-form-item label="多选题题干：" prop="multi_choice_content" size="small">
                                            <div class="chooseContent" v-html="detailFrom.multi_choice_content"></div>
                                        </el-form-item>

                                        <el-form-item label="选择项A：" prop="multi_choice_a" size="small">
                                            <el-checkbox v-model="detailFrom.answer[0]" label="A" disabled="true"></el-checkbox>
                                            <div class="detailChoose" v-html="detailFrom.multi_choice_a"></div>
                                        </el-form-item>

                                        <el-form-item label="选择项B：" prop="multi_choice_b" size="small">
                                            <el-checkbox v-model="detailFrom.answer[1]" label="B" disabled="true"></el-checkbox>
                                            <div class="detailChoose" v-html="detailFrom.multi_choice_b"></div>
                                        </el-form-item>

                                        <el-form-item label="选择项C：" prop="multi_choice_c" size="small">
                                            <el-checkbox v-model="detailFrom.answer[2]" label="C" disabled="true"></el-checkbox>
                                            <div class="detailChoose" v-html="detailFrom.multi_choice_c"></div>
                                        </el-form-item>

                                        <el-form-item label="选择项D：" prop="multi_choice_d" size="small">
                                            <el-checkbox v-model="detailFrom.answer[3]" label="D" disabled="true"></el-checkbox>
                                            <div class="detailChoose" v-html="detailFrom.multi_choice_d"></div>
                                        </el-form-item>
                    ...
                    <div class="edit-dialog">
                        <el-dialog title="修改多选题信息" top="2.5vh" :visible.sync="editDialogVisible" :modal="false"
                            ...
                            <el-form label-position="right" :model="editFrom" ref="editFrom"
                                ...
                                <el-row>
                                    <el-col :span="6">
                                        <el-form-item label="选择项A：" prop="multi_choice_a" size="small">
                                            <el-checkbox v-model="editFrom.answer[0]" label="A"></el-checkbox>
                                            <!-- 加载编辑器的容器 -->
                                    ...
                                    <el-col :span="6" offset="6">
                                        <el-form-item label="选择项B：" prop="single_choose_b" size="small">
                                            <el-checkbox v-model="editFrom.answer[1]" label="B"></el-checkbox>
                                            <!-- 加载编辑器的容器 -->
                                ...
                                <el-row>
                                    <el-col :span="6">
                                        <el-form-item label="选择项C：" prop="single_choose_c" size="small">
                                            <el-checkbox v-model="editFrom.answer[2]" label="C"></el-checkbox>
                                            <!-- 加载编辑器的容器 -->
                                    ...
                                    <el-col :span="6" offset="6">
                                        <el-form-item label="选择项D：" prop="single_choose_d" size="small">
                                            <el-checkbox v-model="editFrom.answer[3]" label="D"></el-checkbox>
                                            <!-- 加载编辑器的容器 -->
                                ...
                                <el-row>
                                    ...
                                    <el-col :span="24">
                                        ...
                                        <el-form-item label="答案解析：" prop="explanationEdit" size="small">
                                            <!-- 加载编辑器的容器 -->
                                            <script id='explanationEdit' v-model="editFrom.explanation" type='text/plain'>
                                            </script>
                                        </el-form-item>
                    ...
                    <div class="import-dialog">
                        <el-dialog title="多选题批量导入" :visible.sync="importDialogVisible" :modal="false" width="26em"
                                   :close-on-click-modal="false" :close-on-press-escape="false" :show-close="false">
