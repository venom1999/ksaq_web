        ...
        methods: {
            ...
            submitadd:function(){
                ...
                if(vm.allmodulelist.length==0)
                {
                    ...
                    $.post("submitAdd", {RoleName: vm.txtrolename,RoleMemo: vm.txtrolememo,RoleInstitution:vm.institutionselected,RolePosition:vm.typeselected,IDList:idlist.join(',')}, function (data) {
                        if (data == "success") {
                            {
                                ELEMENT.Message(
                                    {
