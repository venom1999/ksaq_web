...
<head id="Head1">
    ...
    <script type="text/javascript" src="./js/scoreStatistics.js?<%=Math.random()%>"></script>
    <style type="text/css">
    </style>
    ...
    <el-container>
        <el-header height="48px">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>考核成绩统计</el-breadcrumb-item>
            ...
            <div class="content" v-loading="tableLoading">
                ...
                <div class="section">
                    <el-row style="padding-top: 40px;">
                        <el-col :span="12">
                            <div id="score_histogram" style="width: 800px; height: 600px; margin-left: 4%; padding-top: 40px;">
                            </div>
                        </el-col>

                        <el-col :span="12">
                            <div id="score_pie" style="width: 800px; height: 600px; float: left; margin-left: 4%; padding-top: 40px;">
                            </div>
                        </el-col>
                    </el-row>
                </div>
