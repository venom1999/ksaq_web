...
<head>
    ...
    <script type="text/javascript" src="js/EducationTrain.js?<%=Math.random()%>"></script>
    <style type="text/css">
        ...
        <el-container>
            <el-header height="48px">
                <el-breadcrumb separator="/">
                    <el-breadcrumb-item><a href="">培训计划明细</a></el-breadcrumb-item>
                </el-breadcrumb>
            </el-header>
        </el-container>
        <div class="wrapper">
                        ...
                        <table style="display: block">
                            ...
                            <tr v-for="(record,index) in list" :id="record.education_id" align="center">
                                ...
                                <td>
                                    ...
                                    <el-button type="text" @click="_enter(record.education_id)">报名</el-button>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="pop-dialog">
                    ...
                    <div class="enter-dialog loadingover">
                        <el-dialog title="报名培训管理" top="2.5vh" :visible.sync="enterDialogVisible" :modal="false" v-loading="dialogLoading"
                                   :close-on-click-modal="false" :close-on-press-escape="false" :show-close="true" fullscreen="true">
                            <div class="section">
                                <div class="list-operation">
                                    <el-button type="primary" @click="openAddDialog">添加</el-button>
                                    <el-button type="primary" @click="deleteEmployee">删除</el-button>
                                </div>
                            </div>
