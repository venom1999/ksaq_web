...
public class WebSocket {
     ...
     */
    @OnOpen
    public void onOpen(@PathParam(value = "param") String userno, Session session) throws Exception {

        userNum = userno;
        this.session = session;
        DBo dbo = new DBo();
        dbo.execute("UPDATE userinfo_t set WebStatus = '1'  where EmployeeNum = '" + userNum + "'");
        webSocketSet.put(userNum,this);
        //加入set中
    ...
    public void onClose() throws Exception {
        ...
        webSocketSet.remove(userNum);
        //从set中删除
        subOnlineCount();           //在线数减1
        System.out.println("有一连接关闭！当前在线人数为" + getOnlineCount());
        System.out.println(userNum+"离线");
    }
