...
$(function () {
    ...
    $("#iframePopAdd").click(function () {
        return qBox.iFLoad({ title: '添加公司员工信息', src: 'employeeAdd.aspx', w:740, h: 620 });
    });
    ...
    $("#iframePopDetail").click(function () {
        ...
        if (employeeNum != undefined) {
            return qBox.iFLoad({ title: '公司员工详细信息', src: 'employeeDetail.aspx?employeeNum=' + employeeNum + '&rdom=' + Math.random() + '&fatherCookie=' + getHtmlDocName(), w: 740, h: 620 });
        }
        else {
    ...
    $("#iframePopEdit").click(function () {
        var employeeNum = $("input[.radio][checked]").val(); //获取单选按钮
        if (employeeNum != undefined) {
            return qBox.iFLoad({ title: '修改公司员工信息', src: 'employeeEdit.aspx?employeeNum=' + employeeNum + '&rdom=' + Math.random(), w: 740, h: 620 });
        }
        else {
    ...
    $("#iframePopSpeSec").click(function () {
        ...
        if (employeeNum != undefined) {
            return qBox.iFLoad({ title: '公司员工证书信息', src: 'specialAndSecurityEmployee.aspx?employeeNum=' + employeeNum + '&employeeName=' + employeeName + '&rdom=' + Math.random(), w: 740, h: 580 });
        }
        else {
            alert("请选择您要查看的记录，点击单选按钮选中！");
            return false;
    ...
    $("#iframePopEdu").click(function () {
        ...
        var employeeName = $("input[.radio][checked]").siblings('.employeeName').val();
        if (employeeNum != undefined) {
            return qBox.iFLoad({ title: '公司员工教育培训经历', src: 'employeeEducationInfo.aspx?employeeNum=' + employeeNum + '&employeeName=' + employeeName + '&rdom=' + Math.random(), w: 963, h: 280 });
        }
        else {
            alert("请选择您要查看的记录，点击单选按钮选中！");
            return false;
