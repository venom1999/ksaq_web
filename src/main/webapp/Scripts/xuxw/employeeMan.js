$(function () {
    ...
    $("#iframePopAdd").click(function () {
        return qBox.iFLoad({ title: '添加员工信息', src: 'employeeAdd.aspx', w: 664, h: 634 });
    });

    /*打印层显示*/
    $("#print").click(function () {
        return qBox.iFLoad({ title: '打印员工信息', src: 'employeePrint.aspx', w: 664, h: 400 });
    });
    ...
    $("#iframePopDetail").click(function () {
        ...
        if (employeeNum != undefined) {
            return qBox.iFLoad({ title: '员工详细信息', src: 'employeeDetail.aspx?employeeNum=' + employeeNum + '&rdom=' + Math.random(), w: 664, h: 621 });
        }
        else {
    ...
    $("#iframePopEdit").click(function () {
        var employeeNum = $("input[.radio][checked]").val(); //获取单选按钮
        if (employeeNum != undefined) {
            return qBox.iFLoad({ title: '修改员工信息', src: 'employeeEdit.aspx?employeeNum=' + employeeNum + '&rdom=' + Math.random(), w: 664, h: 633 });
        }
        else {
            alert("请选择您要查看的记录，点击单选按钮选中！");
            return false;
    ...
    $("#iframePopSpeSec").click(function () {
        ...
        if (employeeNum != undefined) {
            return qBox.iFLoad({ title: '显示证书信息', src: 'specialAndSecurityEmployee.aspx?employeeNum=' + employeeNum + '&employeeName=' + employeeName + '&rdom=' + Math.random(), w: 580, h: 345 });
        }
        else {
            alert("请选择您要查看的记录，点击单选按钮选中！");
            return false;
    ...
    $("#iframePopEdu").click(function () {
        var employeeNum = $("input[.radio][checked]").val(); //获取单选按钮
        if (employeeNum != undefined) {
            return qBox.iFLoad({ title: '员工教育培训经历', src: 'employeeEducationInfo.aspx?employeeNum=' + employeeNum + '&rdom=' + Math.random(), w: 763, h: 205 });
        }
        else {
            alert("请选择您要查看的记录，点击单选按钮选中！");
            return false;
