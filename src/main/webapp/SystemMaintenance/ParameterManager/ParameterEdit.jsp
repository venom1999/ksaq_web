	...
	<form id="form_submit">
		<div class="popTxt">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td style="width: 50%; height: 120px;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							class="popTable table table-striped">
							
					       <input name="parameterid"  type="hidden"  id="txt_ParameterID" value="${infolist.parameterid}"></input>
							
						   <tr>
								<th width="30%">参数编号：</th>
								<td><input name="parameteritem" style="width: 180px" type="text"
								     id="txt_ParameterItem" value="${infolist.parameteritem}"></input> 
							...
							<tr>
								...
								<td><input name="parametername" style="width: 180px" type="text" 
								    id="txt_ParameterName" value="${infolist.parametername}"></input> 
								    <font color='red'>*</font> <span
								    style="color: red; display: none" class="hint"> !</span></td>
							</tr>
							<tr>
								...
								<td><input name="parametervalue" style="width: 180px" type="text"
								    id="txt_ParameterValue" value="${infolist.parametervalue}"></input> 
								    <font color='red'>*</font> <span
								    style="color: red; display: none" class="hint"> !</span></td>
							</tr>
						</table>
		  ...
		  <div class="pop_btnBorder">
				<div class="pop_btn">
					<i> 
					<input type="button" id="btn_close" value="关闭" class="btnright redbtn" onclick="parent.qBox.Close();" /> 
					<input type="button" id="btn_submit_update" value="保存" class="btnright bluebtn" />
