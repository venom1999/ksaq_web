...
<head id="Head1">
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/static/js/moment.js"></script>
    <script type="text/javascript" src="scripts/UserDetailEvents.js"></script>
    <style>
                    ...
                    <div class="list-filter">
                        <el-row>
                            ...
                            <el-col :span="6">
                                ...
                                <el-col :span="16">
                                    <el-input v-model="txtInstitutionName" readonly="true"></el-input>
                                </el-col>
                            </el-col>
                            <el-col :span="6">
                                <el-col class="filter-label" :span="7">
                    ...
                    <div class="list-table">
                        <table>
                            <tr>
                                ...
                                <th style="text-align: center" width="25%">是否增删改</th>
                            </tr>
