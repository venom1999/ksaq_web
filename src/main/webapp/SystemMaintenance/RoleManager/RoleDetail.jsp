...
--%>
    ...
    <script type="text/javascript" src="scripts/RoleDetailEvents.js"></script>
    <style>
    ...
    <el-container>
        <el-header height="48px">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>角色详细信息</el-breadcrumb-item>
            </el-breadcrumb>
        </el-header>
                    ...
                    <div class="list-filter">
                        <el-row>
                            ...
                            <el-col :span="6">
                                ...
                                <el-col :span="16">
                                    <el-select v-model="typeselected" filterable placeholder="请选择"
                                               :disabled="typeEnabled" @change="dpType_SelectedIndexChanged">
                            ...
                            <el-col :span="6">
                                ...
                                <el-col :span="16">
                                    <el-input type="textarea" autosize v-model="txtrolename" :disabled="txtrolenameEnabled"></el-input>
                                </el-col>
                            </el-col>
                            <el-col :span="6">
                                <el-col class="filter-label" :span="7">
                                ...
                                <el-col :span="16">
                                    <el-input type="textarea" autosize v-model="txtrolememo" :disabled="txtrolememoEnabled"></el-input>
                                </el-col>
                            </el-col>
                        </el-row>
                    </div>
                        ...
                        <table>
                            ...
                            <tr v-for="(record,index) in allmodulelist" align="center">
                                ...
                                <td style="vertical-align: middle;">
                                    <el-checkbox size="medium" :true-label="record.modulenum" :disabled="true"
