...
<head id="Head1">
    ...
    <script type="text/javascript" src="./js/dataStatistics.js?<%=Math.random()%>"></script>
    <style type="text/css">
    </style>
    ...
    <el-container>
        <el-header height="48px">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>个人成绩统计</el-breadcrumb-item>
                <el-breadcrumb-item><a href="score_vue">考核成绩统计</a></el-breadcrumb-item>
                <el-breadcrumb-item><a href="rate_vue">部门分数统计</a></el-breadcrumb-item>
            </el-breadcrumb>
        </el-header>
        ...
        <div class="wrapper">
            <div class="content" v-loading="tableLoading">
                ...
                <div class="section" v-show="right">
                    <%--权限查询--%>
                            ...
                            <el-col :span="7">
                                ...
                                <el-col :span="16">
                                    <el-select v-model="params[0].value" filterable clearable placeholder="请选择">
                                        <el-option v-for="record in userList"
                                                   :value="record.EmployeeNum"
                                                   :label="record.EmployeeID + '-' + record.EmployeeName">
                                        </el-option>
                                    </el-select>
                                </el-col>
                            </el-col>
                ...
                <div id="diagram" style="width: 800px; height: 600px;margin:0 auto; padding-top: 40px;">
                </div>
